...
class ResumeGenerator:
    ...
    def _add_hyperlink(self, paragraph, url, text):
        ...
        fonts.set(qn("w:ascii"), self.body_font)
        fonts.set(qn("w:hAnsi"), self.body_font)
        r_pr.append(fonts)
...
if __name__ == "__main__":
    ...
    test_content = {
        ...
        "bee_data": ["Bee data point 1"],
        "allied_health": ["Allied point 1"],
        "byjus": ["Byjus point 1"],
        "cognizant": ["Cognizant point 1"],
    }
